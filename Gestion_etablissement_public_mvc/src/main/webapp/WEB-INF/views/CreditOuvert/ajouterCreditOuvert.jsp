    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">  Nouveau Credit Ouvert</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                ...
                <div class="row">
	                ...
	                <br /> <br />
	                        ...
	                        <div class="panel-body">
	                        	<c:url value="/creditOuvert/enregistrer" var ="urlEnregistrerCreditOuvert" />

	                        	 <f:form modelAttribute="creditOuvert" action="${urlEnregistrerCreditOuvert }"  role = "form">
