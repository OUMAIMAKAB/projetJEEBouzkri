    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">  Modifier Credit Ouvert</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                ...
                <div class="row">
	                ...
	                <br /> <br />
	                        ...
	                        <div class="panel-body">
	                        	<c:url value="/creditOuvert/enregistrerModification" var ="urlEnregistrerModificationCreditOuvert" />

	                        	 <f:form modelAttribute="creditOuvert" action="${urlEnregistrerModificationCreditOuvert }"  role = "form">
                                    ...
                                    <div class="panel-footer">
                                    	...
                                    	<a href="<c:url value="/creditOuvert/" />" class="btn btn-danger"> annuler </a>
                                    </div>
								</f:form>
