            ...
            <div class="container-fluid">
                <div class="row">
                 ...
                 <div class="row">
					<div class="col-lg-12">
						<ol class="breadcrumb">
						  <li><a href="<c:url value="/exercice/nouveau" />" ><i class="fa fa-plus">&nbsp;ajouter</i></a></li>
                                     ...
                                     <tr>
                                       <td> ${exercice.getAnnee()}</td>
                                           ...
                                           <td>
	                                        	...
	                                        	<a href="javascript:void(0);" data-toggle="modal" data-target="#modalExercice${exercice.getAnnee() }"><i class="fa fa-trash-o">supprimer</i></a>
	                                        	<div class="modal fade" id="modalExercice${exercice.getAnnee() }" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
													<div class="modal-dialog">
														<div class="modal-content">
															...
															<div class="modal-body">
																Confirmer la suppresion de l'exercice ${exercice.getAnnee() }
															</div>
															<div class="modal-footer">
																<button type="button" class="btn btn-default" data-dismiss="modal"> annuler</button>
																<c:url value="/exercice/supprimer/${exercice.getAnnee() }" var="urlSuppressionExercice" />
																<a href="${urlSuppressionExercice }" class="btn btn-danger"><i class="fa fa-trash-o"></i>&nbsp;confirmer </a>
															</div>
														</div>
														<!-- /.modal-content -->
													</div>
