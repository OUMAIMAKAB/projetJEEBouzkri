    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">  Modifier Mode Paiement</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                ...
                <div class="row">
	                ...
	                <br /> <br />
	                        ...
	                        <div class="panel-body">
	                        	<c:url value="/modePaiement/enregistrerModification" var ="urlEnregistrerModificationModePaiement" />

	                        	 <f:form modelAttribute="modePaiement" action="${urlEnregistrerModificationModePaiement}"  role = "form">
									 
                                     
									<f:hidden path="idModePaiement"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <f:input path="dateEmission" class="form-control" placeholder="dateEmission" />
                                        <f:errors path="dateEmission" style="color: red;"></f:errors>
                                    </div>
                                    
                                    <div class="form-group">
                                        <label>dateDecaissement</label>
                                        <f:input path="dateDecaissement" class="form-control" placeholder="dateDecaissement" />
                                        <f:errors path="dateDecaissement" style="color: red;"></f:errors>
                                    </div>
