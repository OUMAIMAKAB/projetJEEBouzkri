    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">  Modifier Rubrique</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                ...
                <div class="row">
	                ...
	                <br /> <br />
	                        ...
	                        <div class="panel-body">
	                        	<c:url value="/rubrique/enregistrerModification" var ="urlEnregistrerModificationRubrique" />
								<f:form modelAttribute="rubrique" action="${urlEnregistrerModificationRubrique }"  role = "form">
									
									<f:hidden path="idRubrique"/>								
